...
가정: 선발 7명 · 주간 **3.299경기**(`cat_model.GAMES_PER_WEEK` · 확정 일정 실측) ·
팀 주간 3PA는 **7코어 로스터 실측 평균**(고정값 아님 · 아래 표 각주 참조) ·
기준선 3PT%는 `cat_baselines`

> ⚠️ 38차 정정: 종전 가정은 `주 3.5경기 · 팀 주간 3PA 135`였고, 135는 코어별 실측
> 범위 **밖**이었습니다. 분모가 실제보다 19~74% 커서 아래 표의 레버리지가 **전원
> 과소 계상**돼 있었습니다. 근거: `docs/10-rate-cat-leverage.md`
```
...
|---|---|---|---|---|---|---|
| Kon Knueppel | 7.9 | 27 | 27.7% | 42.5% | **+1.70pp** | ±9.5pp |
| Jamal Murray | 6.9 | 24 | 24.2% | 41.9% | **+1.34pp** | ±10.2pp |
| AJ Green | 6.3 | 22 | 22.1% | 42.2% | **+1.29pp** | ±10.7pp |
| Luke Kennard | 3.4 | 12 | 12.0% | 46.2% | **+1.18pp** | ±14.6pp |
| Cameron Johnson | 5.7 | 20 | 20.1% | 41.3% | **+1.00pp** | ±11.1pp |
| **Josh Hart** | 3.5 | 12 | 12.4% | 37.8% | +0.18pp (최하) | ±14.0pp |

기준선 3PT% 36.4%(`cat_baselines`) · 주간 3.417경기 · 팀 주간 3PA 97.5 가정. 변동성은 이항 SD √(p(1−p)/주간시도). 대상 19명 중 상위 5 + 최하 1.
<!-- /GEN:leverage -->
...
| $54-60 | $52 | Donovan Mitchell | 🟢 **이 방 대비 우위 +$22**(4위) — 작년 이 방이 $27에 넘겼다. 🔴 **상한은 그대로 $52다** — 우위가 크다는 것과 상한이 없다는 것은 다르다. ⚠️ 작년 한 번의 표본이다(올해는 다르게 갈 수 있다). |
| $52-58 | $51 | Jamal Murray | 빅맨 캣(OREB·BLK·DD) 기여 없음 · 🟢 **이 방 대비 우위 +$29**(3위) — 작년 이 방이 $20에 넘겼다. 🔴 **상한은 그대로 $51다** — 우위가 크다는 것과 상한이 없다는 것은 다르다. ⚠️ 작년 한 번의 표본이다(올해는 다르게 갈 수 있다) |
...
| $34-40 | $26 | Stephen Curry | 43경기 · A/T 1.68 하위권 · 빅맨 캣 전무 · 3PT% 엘리트 아님(오분류 정정) |
...
| $28-34 | $19 | Lauri Markkanen | OREB·DD·AST 기여 낮음 |
| $26-32 | $24 | Devin Booker | 빅맨 캣 기여 0 |
| $24-30 | $22 | Paolo Banchero | OREB·BLK 기여 낮음 |
| $20-26 | $16 | Jalen Williams | 33경기 · 3PT% 29.9% 악재 |
| $19-25 | $10 | Anthony Davis | 2025-26 20경기(2024-25 51경기 사용) · GP 리스크 · Ayton과 겹침 · BLK 엘리트 오분류 정정 |
| $12-18 | $10 | Kyrie Irving | 2025-26 전체 결장(ACL) — 가중치 근거는 2024-25 50경기 · 복귀 시점 불확실 · 3PT% 엘리트 아님(오분류 정정) |
| $5-11 | $2 | Gary Trent Jr. | 매수 대상 아님 — 코어 후보에서 제외됨 |
| $4-10 | $3 | Dejounte Murray | A/T 하위 · 부상 이력 |
| $1-3 | $4 | Russell Westbrook | 🚫 은퇴 — 2026 오프시즌 은퇴. 킹스·위저즈 제안을 거절하고 19번째 시즌을 뛰지 않는다. 드래프트 대상이 아니다 |

총 31명 (`obtainable=false` — 내 최대가 < 시장 하단).
<!-- /GEN:unobtainable -->
