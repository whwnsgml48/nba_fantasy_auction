...
| **조건부** | Jokić ≤ $97 | **C2** — Jokić 압축 | 스타 집중형. 예산이 Jokić·D.White에 잠기므로 조건 충족 시에만 진입. |
...
| C2 | SG | Derrick White | $39 | $52 | $13 | **$4** | `budget` | 치환 → De'Aaron Fox | 획득 가능 |
...
| c6 | 93.3% | 37.1% | 45.7% | 58.5% | 93.0% | 45.5% | **37.1%** | 가치최대 | 61.5% |
| c7 | 92.2% | 36.2% | 43.9% | 55.6% | 90.1% | 51.6% | **36.2%** | 가치최대 | 39.6% |
| c5 | 90.7% | 32.3% | 39.1% | 54.5% | 87.2% | 44.9% | **32.3%** | 가치최대 | 40.2% |
| c3 | 90.0% | 30.5% | 43.1% | 58.8% | 88.7% | 44.3% | **30.5%** | 가치최대 | 48.0% |
| c4 | 91.3% | 29.4% | 37.0% | 54.9% | 89.6% | 43.4% | **29.4%** | 가치최대 | 43.7% |
| c2 | 86.9% | 27.8% | 35.1% | 46.0% | 84.3% | 28.5% | **27.8%** | 가치최대 | 71.4% |
...
> Jokić가 AST·A/T(+0.241)를 공급하므로 PG를 최저가로 때우고 Derrick White를 붙인다.

🔴 **39차 판정: c2는 승률로는 7코어 중 최하위다** (79.2% · c6 87.5% 대비 −8.3%p).
겹침 제약 하에서 재설계를 탐색했고 **84~85%에서 수렴**했다 — c6에 −2.5~3.5%p 부족하고
최저 승률은 −5%p 이상 부족하다. **재설계로 개선되지 않는다.**
그리고 **Jokić가 싸게 나와도 c6를 짓는 것이 낫다** — Jokić 할인은 c6의 승률을 바꾸지
않는다(c6는 그를 쓰지 않는다). 즉 이 분기는 조건이 충족돼도 갈 이유가 없다.

**남겨두는 이유는 승률이 아니라 집합 수준 역할이다** — Dyson Daniels를 안 쓰는 유일한
코어이고(⑤′ · `core_set_escape_paths_39`), 폐기하면 그의 비의존 경로가 0이 된다.
다만 Daniels를 못 잡을 확률이 ~0.06이므로 **그 보험의 값어치도 ~0에 가깝다.**
그래서 재설계도 폐기도 하지 않는다 — 셋 다 값이 없어 **아무것도 하지 않는 것이 맞다.**

**계획 $196** · 예비비 **$4** · 빅맨 $143/$153 (C자격 4명) · 노리는 캣 9개 `A/T AST BLK DD FG% OREB PTS REB TOV` · 포기 `3P% 3PM FT% STL`

**주간 승률** 최소 **27.8%** (vs 가치최대) · 빅5 동시붕괴 71.4% · 기대 승리 캣 8.65
...
| 슬롯 | 계획가 | 상한 | 여력 | 역할 | 1순위 | 대체 ① | 대체 ② |
|---|---|---|---|---|---|---|---|
| **C** `앵커` | $97 | $97 | **$0** (실패→C6) | 앵커 (실패 시 코어 전환) | **Nikola Jokić** `C` | — | — |
| **SG** `앵커` | $39 | $44 | **$4** (실패→치환 De'Aaron Fox) | A/T +0.171 · FT% 90.2% · BLK 1.3 | **Derrick White** | De'Aaron Fox $24 | Dennis Schröder $5 |
| **PF** | $26 | $34 | — | OREB 3.0 · DD 34 · AST | **Alperen Şengün** `C` | Evan Mobley $23 | — |
...
**피벗 최종 9인** — 총액 $183 · 예비비 $17 · 빅맨 $128 (C자격 3명) · 노리는 캣 `3P% 3PM A/T AST DD OREB TOV` · 포기 `BLK FG% FT% PTS REB STL`
...
**주간 승률** 최소 **30.5%** (vs 가치최대) · 빅5 동시붕괴 48.0% · 기대 승리 캣 8.73
...
**주간 승률** 최소 **29.4%** (vs 가치최대) · 빅5 동시붕괴 43.7% · 기대 승리 캣 8.51
...
**주간 승률** 최소 **32.3%** (vs 가치최대) · 빅5 동시붕괴 40.2% · 기대 승리 캣 8.69
...
**주간 승률** 최소 **37.1%** (vs 가치최대) · 빅5 동시붕괴 61.5% · 기대 승리 캣 8.89
...
**주간 승률** 최소 **36.2%** (vs 가치최대) · 빅5 동시붕괴 39.6% · 기대 승리 캣 8.91
