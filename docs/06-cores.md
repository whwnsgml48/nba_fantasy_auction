...
> **정상 시장: 코어 6 기본 → Hali 할인 시 코어 1 → SGA 할인 시 코어 3 → 앵커 실패 시 코어 4. 저가 센터 2명 이상 과열: 즉시 코어 7. 🔴 **Jokić를 $97 이하로 잡으면 즉시 코어 2** — ~~상위 5개와 동급이고~~ **가정이 없다**(1순위 전원 직전 시즌 실측). ⚠️ **44차 정정: 「동급」은 더 이상 참이 아니다** — c2 86.7% vs c6 90.2% 로 c6 가 앞선다. c2 의 값은 **동급이라서가 아니라 「가정이 없다 + 조달 배율 1.06 (유일하게 예산 안에 들어온다)」** 때문이다. 그 둘은 그대로 유효하다. Sabonis는 조건 충족 시에만 별도 진입.
...
🔴 **44차**: c6 BN 1순위가 Desmond Bane → **Jamal Murray** 로 바뀌었다(+2.63%p · 5.2σ · 감축① 후 +3.10%p). 위 「상위 다섯은 1.2%p 안이라 승률로 못 고른다」는 **더 이상 참이 아니다** — c6 가 2위와 **2.67%p** 벌어졌다(재측정 대응 SE **0.68%p** 의 3.9배)(`core_selection_hierarchy_42.amended_44`). ⚠️ 단 그 우위는 **Murray 를 $31 이하에 잡을 때만** 성립한다. 못 잡으면 Bane → Brunson 으로 내려가고 c6 는 87.9% 로 돌아간다 — **목적지는 그래도 c6 다.** 판단표는 안 바뀐다.**
...
| **조건부 ★** | Jokić ≤ $97 낙찰 → 즉시 코어 2 | **C2** — Jokić 압축 | 🔴 **게이트가 열리면 조립 가능성 순서를 앞선다** — ~~상위 5개와 **동급**이고~~ **가정 취약성이 ±0**이다\n⚠️ **44차 정정: 「동급」이 아니다.** 재측정 c6 90.2% · c3 88.1% · c1 87.4% · c2 86.7% · c7 86.5% (대응 SE 0.68%p) — **c6 가 c2 보다 3.5%p 앞선다.** 그래도 이 게이트를 유지하는 이유는 **승률이 아니라** ① 가정 취약성 ±0 ② 조달 배율 **1.06** — 일곱 중 유일하게 작년 가격으로 $200 안에 들어온다. 🔴 즉 c2 는 「c6 만큼 강해서」가 아니라 **「c6 를 못 사게 됐을 때 실제로 살 수 있어서」** 값이 있다. 그 근거는 44차에도 그대로다. — 1순위 아홉 명 전원이 직전 시즌 실측 위에 있어 프리시즌을 몰라도 안 흔들린다. 📌 이전에 여기 적혀 있던 **「88.9%로 전 코어 1위」는 철회됐다.** 그 값은 포지션 자격을 모르는 모델이 만든 것으로, C 전용 5명을 매일 다 쓸 수 있다고 계산했다. 자격을 반영하니 c2만 −2.4%p 움직였다(나머지 여섯은 ±0.4%p 안). ⏱ **Jokić는 최상위 선수라 드래프트 초반에 지명된다 — 즉 이 게이트의 개폐를 초반에 알게 된다.** 그 시점에 $97 이하로 잡았다면 기본값 c6로 가지 말고 c2로 전환하라. |
...
|---|---|---|---|---|---|---|---|---|---|
| c1 | 92.9% | 51.2% | 71.0% | 57.7% | 90.7% | 53.9% | **51.2%** | 가치최대 | 18.6% |
| c6 | 94.7% | 50.8% | 65.6% | 63.9% | 94.0% | 50.2% | **50.2%** | 벤치마크 | 35.6% |
| c7 | 92.1% | 48.5% | 67.8% | 57.5% | 90.8% | 54.0% | **48.5%** | 가치최대 | 16.6% |
| c3 | 92.5% | 45.6% | 68.0% | 61.0% | 92.5% | 51.4% | **45.6%** | 가치최대 | 20.3% |
| c2 | 90.8% | 48.3% | 63.2% | 63.6% | 90.9% | 44.9% | **44.9%** | 벤치마크 | 58.4% |
| c5 | 90.5% | 44.0% | 63.7% | 56.5% | 87.3% | 47.5% | **44.0%** | 가치최대 | 19.1% |
| c4 | 90.8% | 40.6% | 60.9% | 55.7% | 88.5% | 47.9% | **40.6%** | 가치최대 | 21.6% |
...
**주간 승률** 최소 **51.2%** (vs 가치최대) · 빅5 동시붕괴 18.6% · 기대 승리 캣 8.99
...
**주간 승률** 최소 **44.9%** (vs 벤치마크) · 빅5 동시붕괴 58.4% · 기대 승리 캣 9.19
...
**주간 승률** 최소 **45.6%** (vs 가치최대) · 빅5 동시붕괴 20.3% · 기대 승리 캣 8.75
...
**주간 승률** 최소 **40.6%** (vs 가치최대) · 빅5 동시붕괴 21.6% · 기대 승리 캣 8.52
...
**주간 승률** 최소 **44.0%** (vs 가치최대) · 빅5 동시붕괴 19.1% · 기대 승리 캣 8.73
...
**주간 승률** 최소 **50.2%** (vs 벤치마크) · 빅5 동시붕괴 35.6% · 기대 승리 캣 9.10
...
**주간 승률** 최소 **48.5%** (vs 가치최대) · 빅5 동시붕괴 16.6% · 기대 승리 캣 8.88
